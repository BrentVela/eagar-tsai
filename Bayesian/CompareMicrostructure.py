...
CORRECTED_CSV = Path("beamer/figures/bayesian/cartesian_solvertest2/BU_GR_data.csv")
OUTPUT_PATH = Path("beamer/figures/bayesian/cartesian_solvertest2/microstructure_TCAM_vs_corrected.png")
