...
\begin{frame}[t]{Why Predict Microstructure?}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.44\textwidth}
      \centering
      \includegraphics[width=\linewidth,height=0.52\textheight,keepaspectratio]{../beamer/figures/phase_field_microstructure_proxy.png}

      \vspace{0.25em}
      {\fontsize{14}{17}\selectfont Illustrative phase-field style microstructure proxy: thermal history must be connected to grain morphology and phase contrast.\par}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Cellular Automata Solidification Modes}
  ...
  \vspace{0.70cm}
  \begin{alertblock}{{\fontsize{22}{26}\selectfont Use in this workflow}}
    \vspace{0.25em}
    {\fontsize{24}{29}\selectfont
    Eagar--Tsai supplies fast local $G$ and $R$ fields; Bayesian correction should make those fields reliable enough to classify the microstructure.\par}
    \vspace{0.25em}
  \end{alertblock}
\end{frame}
