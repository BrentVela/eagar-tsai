  ...
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.28\textwidth}
      ...
      \raisebox{0.70cm}{%
        ...
        ]{../beamer-template/figures/et_melt_pool_vertical.png}%
      }
    \end{column}
    \begin{column}{0.46\textwidth}
      ...
      \includegraphics[
        ...
        keepaspectratio
      ]{../beamer-template/figures/TCAM/ET_TC_temp_yz_0_80_160um_inferno.png}
    \end{column}
    \begin{column}{0.23\textwidth}
      ...
      \raisebox{0.70cm}{%
        ...
        \includegraphics[
          height=0.715\textheight
        ]{../beamer-template/figures/tc_melt_pool_vertical.png}%
      }
    \end{column}
  \end{columns}
  \end{minipage}
